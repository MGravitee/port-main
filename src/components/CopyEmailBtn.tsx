...
const CopyEmailBtn: React.FC<Props> = ({ email }) => {
    ...
    return (
        <motion.button
            ...
            className="group relative overflow-hidden rounded-bl-lg rounded-tr-lg border-2 w-fit border-current bg-inherit px-4 py-2 font-mono font-medium uppercase text-current transition-colors hover:text-[#ff8f1f] no-motion"
        >
