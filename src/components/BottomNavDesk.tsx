...
const BottomNavDesk = () => {
    ...
    group-hover:backdrop-brightness-20 border-content1 shadow-medium rounded-medium backdrop-blur-2xl backdrop-brightness-50 hover:bg-content1 hover:bg-opacity-75 transition-all"
        >
