      ...
      {projects.map((project, index) => (
        <div key={project.id} className="accordion-item mb-4">
          <button
            ...
            className="accordion-title text-left w-full p-4 text-lg font-medium bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
          ...
          >
            <div className="project-details">
              <img
                className="project-img w-full h-auto rounded-lg mb-4"
